...
####################################################################################################################
#OUTPUTS: New_Line_Name_Molecule_Count/Turnover/Transcription_Dynamics_Compile.csv and New_All_Cell_Lines_Molecule_Count/Turnover/Transcription_Dynamics_Compile.csv 
